<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="社长" prop="clubAdmin">
        <el-input
          v-model="queryParams.clubAdmin"
          placeholder="请输入社长"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="clubList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="社团简介" align="center" prop="content" />
      <el-table-column label="社长" align="center" prop="clubAdmin" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="社长" prop="clubAdmin">
          <el-input v-model="form.clubAdmin" placeholder="请输入社长" />
        </el-form-item>
      </el-form>
...
<script>
import { listClub, getClub, delClub, addClub, updateClub } from "@/api/system/club";
